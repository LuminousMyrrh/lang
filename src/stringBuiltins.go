...
func stringSubstring(e *Evaluator, self *Env, args []any, pos Position) any {
	s, err := getValue(self)
	if err != nil {
...
func stringCapitalize(e *Evaluator, self *Env, args []any, pos Position) any {
	if len(args) != 0 {
...
// func stringFind(e *Evaluator, self *Env, args []any, pos Position) any {
...
func stringContains(e *Evaluator, self *Env, args []any, pos Position) any {
	if len(args) != 1 {
